...
vim.keymap.set('n', '<leader>og', telescope_live_grep_open_files, { desc = '[G]rep search in [o]pen files' })
vim.keymap.set('n', '<leader>tb', require('telescope.builtin').builtin,
  { desc = 'Search [t]elescope [b]uiltin functions' })
vim.keymap.set('n', '<leader>tk', require('telescope.builtin').keymaps,
  { desc = 'Search [t]elescope [k]eymaps list' })
